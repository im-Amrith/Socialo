...
- **Infrastructure**: The current implementation utilizes an authenticated Gmail SMTP relay, which provides a highly reliable and easily configurable delivery mechanism without the sandbox restrictions common to third-party services like Resend or SendGrid during early development.
